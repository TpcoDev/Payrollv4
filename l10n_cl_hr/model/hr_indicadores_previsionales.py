...
class hr_indicadores_previsionales(models.Model):
    ...
    def update_document(self):
        ...
        try:
            ...
            self.tope_imponible_ips = string_divide(clear_string(letters[3].select("strong")[2].get_text()), self.uf, 2)
            ...
            self.asignacion_familiar_monto_a = clear_string(letters[10].select("strong")[4].get_text())
            self.asignacion_familiar_monto_b = clear_string(letters[10].select("strong")[6].get_text())
            self.asignacion_familiar_monto_c = clear_string(letters[10].select("strong")[8].get_text())

            self.asignacion_familiar_primer = clear_string(letters[10].select("strong")[5].get_text())[1:]
            self.asignacion_familiar_segundo = clear_string(letters[10].select("strong")[7].get_text())[6:]
            self.asignacion_familiar_tercer = clear_string(letters[10].select("strong")[9].get_text())[6:]
