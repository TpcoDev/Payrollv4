...
class hr_contract(models.Model):
    ...
    carga_familiar_maternal = fields.Integer('Carga Maternal',
                                             help="Carga familiar para el cálculo de asignación familiar maternal")
    carga_familiar_invalida = fields.Integer('Carga Inválida',
    ...
    isapre_moneda = fields.Selection(selection=[('uf', 'UF'), ('clp', 'Pesos')], string='Tipo de Moneda', default="uf")
    ...
    aporte_voluntario_moneda = fields.Selection(selection=[('uf', 'UF'), ('clp', 'Pesos')], string='Tipo de Moneda',
                                                default="uf")
    forma_pago_apv = fields.Selection(selection=[('1', 'Directa'), ('2', 'Indirecta')], string='Forma de Pago',
                                      default="1")
    seguro_complementario_moneda = fields.Selection(selection=[('uf', 'UF'), ('clp', 'Pesos')], string='Tipo de Moneda',
                                                    default="uf")
